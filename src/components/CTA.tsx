...
export default function CTA() {
  return (
    <section id="contactos" className="bg-white px-5 pb-24 md:px-10 md:pb-32">
      <div
        data-reveal
        className="relative mx-auto max-w-container overflow-hidden rounded-[2rem] bg-brand-gradient px-6 py-14 text-center text-white shadow-lift md:px-16 md:py-20"
      >
        ...
        <a
          ...
          className="relative mt-8 inline-flex items-center justify-center gap-2.5 rounded-full bg-white px-8 py-4 text-sm font-semibold text-deep shadow-soft transition-transform hover:scale-[1.03] active:scale-95"
        >
